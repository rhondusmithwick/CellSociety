...
class Controls {
    ...
    public Controls(SimulationControl mySimulationControl,String resource) {
    ...
    private void createControls() {
        ...
        mySetSizeButton = makeButton(myResources.getString("SetSizeButton"), event -> mySimControl.sizeChange(inputTextField.getText()));
