...
//
//
//    public void fishUpdate(PredatorPreyCell myFish) {
//        List<PredatorPreyCell> emptyNeighbors = myFish.countNeighbors(State.EMPTY);
//        if (myFish.getTurnsSurvived() > breedTime) {
//            if (!emptyNeighbors.isEmpty()) {
//                PredatorPreyCell newFish = emptyNeighbors.get(0);
//                newFish.setState(State.FISH);
//                emptyNeighbors.remove(0);
//                createFishCells.add(newFish);
//            }
//        }
//        if (!emptyNeighbors.isEmpty()) {
//            int randomIndex = getRandomNum(0, emptyNeighbors.size() - 1);
//            PredatorPreyCell ppc = emptyNeighbors.get(randomIndex);
//            ppc.setState(State.BECOMINGFISH);
//        }
//
//    }
//
